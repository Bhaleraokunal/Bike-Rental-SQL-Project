                                ...
                                <div class="panel-body">
                                    <form method="post" class="form-horizontal" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" name="vehicletitle" class="form-control" placeholder="Enter vehicle title" required>
                                            </div>
                                            
                                            <label class="col-sm-2 control-label">Select Brand<span style="color:red">*</span></label>
                                            <div class="col-sm-4">
                                                <select class="form-control selectpicker" name="brandname" data-live-search="true" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea class="form-control" name="vehicalorcview" rows="3" placeholder="Enter vehicle overview" required></textarea>
                                            </div>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Price Per Day (USD)<span style="color:red">*</span></label>
                                            <div class="col-sm-4">
                                                <input type="number" name="priceperday" class="form-control" placeholder="Enter price per day" required>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="number" name="modelyear" class="form-control" placeholder="Enter model year" required>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-4">
                                                ...
                                                <img id="preview1" src="#" alt="" class="img-thumbnail" style="display:none; max-width:100px;">
                                            </div>
                                            <div class="col-sm-4">
                                                Image 2 <span style="color:red">*</span>
                                                <input type="file" name="img2" accept="image/*" onchange="previewImage(event, 'preview2')" required>
                                                <img id="preview2" src="#" alt="" class="img-thumbnail" style="display:none; max-width:100px;">
                                            </div>
                                        </div>
